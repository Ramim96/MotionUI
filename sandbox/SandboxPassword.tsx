...
// Components
import { PasswordField } from "@design-system/input-fields/PasswordField";
// Utils
...
export const SandboxPasswordField = () => {
    ...
    const [requiredPassword, setRequiredPassword] = useState<string>("");
    const [invalidPassword, setInvalidPassword] = useState<string>("password123");
